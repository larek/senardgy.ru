...
<div class="panel panel-default">
  <div class="panel-body">
    <div class="starter-template">
        <p class=""> Группа Компаний "Сэнарджи®" является разработчиком и производителем систем наружной теплоизоляции фасадов зданий "Сэнарджи® МвС" и "Сэнарджи® ПпС-3". Системы утепления "Сэнарджи®" полностью сертифицированы и имеют сертификаты соответствия 
ГОСТ Р 56707-2023.</p>
</div>
  </div>
</div>
